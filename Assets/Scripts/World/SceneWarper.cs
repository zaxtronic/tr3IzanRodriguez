...
namespace World
{
    ...
    public class SceneWarper : MonoBehaviour
    {
        ...
        public void OnDrawGizmos()
        {
            ...
            {
                if (transform.hasChanged && lastPosition != transform.position)
                {
                    if (location != null)
                    {
                        location.Set(this);
            ...
            if (lastSpawnLocationPosition != spawnLocation.transform.position)
            {
                ...
                Gizmos.color = getBounds.Contains(spawnLocation.transform.position) ? Color.red : Color.green;
    ...
    public class SceneWarperInspector : UnityEditor.Editor
    {
