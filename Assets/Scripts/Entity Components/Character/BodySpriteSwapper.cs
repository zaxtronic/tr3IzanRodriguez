...
namespace Entity_Components.Character
{
    ...
    public class BodySpriteSwapper : MonoBehaviour, ISaveable
    {
        ...
        private UnityEngine.Sprite lastSprite;

        private Dictionary<UnityEngine.Sprite, string> cachedSpriteNames = new Dictionary<UnityEngine.Sprite, string>();
        ...
        private string GetSpriteName(UnityEngine.Sprite sprite)
        {
            string name;
